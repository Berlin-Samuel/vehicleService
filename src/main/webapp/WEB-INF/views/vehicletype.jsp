...
<title>Add BooK service and Add Payment</title>
...
            <h1>Add BooK service and Add Payment</h1>
            <div class="layout">
                <div class="admin">
                <div class='fas fa-user-cog' style='font-size:115px;color:black'></div>
                    <h2>
                        <a href="/vehicletype/addvehicletype?userId=${userId}" style="text-decoration:none">Add New Vehicle</a>
                    </h2>
                </div>
                <div>
...
                    <h2>
                        <a
							href="/vehiclebookservice/addbookservice?userId=${userId}"
							style="text-decoration: none">Add Book Service</a>                     </h2>
                </div>
            </div>
        </form:form>
    </div>
