...
public class ServiceDetailsController {
	private static final String SERVICEDETAILSLIST = "redirect:/vehicleservicedetails/servicedetailslist";
	@Autowired
	...
	public String addSeviceDetailsByServiceid(@RequestParam("id") int servId, @RequestParam("bookId") int bookingId,
			Model model) {
